...
* lastly, we need to create a symbolic link of `NSF/WebContent/` to `public` for our json-server to pick it up where it's expected
  ...
  * <amp-img src="{{ site.url }}/assets/images/post_images/jsonServerMaintScreen.png" alt="json-server's default maintenance screen" layout="responsive" width="522" height="525"></amp-img>
...
<figure>
  <amp-img src="{{ site.url }}/assets/images/post_images/minifiedJavaScript_jQueryVend.png"
  alt="jQuery minified for production"
  width="722" height="131"
  layout="responsive"></amp-img>
 <figcaption>jQuery minified for production</figcaption>
</figure>
